  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('danhsachquyen.index')}}"><span>Quyền<span></a></li>
        <li class="active"><a href="{{route('danhsachloai.index')}}"><span>Loại nông sản<span></a></li>
        <li class="active"><a href="{{route('danhsachnguoidung.index')}}"><span>Người dùng<span></a></li>
        <li class="active"><a href="{{route('danhsachsanpham.index')}}"><span>Nông sản<span></a></li>
